<template>
  <div class="sm:container sm:mx-auto sm:mt-10 sm:px-6">
    <div v-if="$page.flash.success && show" class="mb-8 flex items-center justify-between bg-green-400 rounded w-full">
