  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "flex flex-col" }, [
        _vm.$page.route.hasLogin
          ? _c(
              "div",
              {
                staticClass:
                  "absolute top-0 right-0 mt-4 mr-4 space-x-4 sm:mt-6 sm:mr-6 sm:space-x-6"
              },
              [
                _c(
                  "inertia-link",
                  {
                    staticClass:
                      "no-underline hover:underline text-sm font-normal text-teal-800 uppercase",
            ...
            _c("div", { staticClass: "flex flex-col justify-around h-full" }, [
              _c("div", [
                _c(
                  ...
                  {
                    staticClass:
                      "mb-6 text-gray-600 text-center font-light tracking-wider text-4xl sm:mb-8 sm:text-6xl"
                  },
                  [
                    _vm._v(
                      "\t\n\t\t\t\t\t" +
