                            ...
                            [
                              _vm.user.role == 1
                                ? _c(
                                    ...
                                    {
                                      staticClass:
                                        "px-4 ml-5 bg-green-400 text-white p-2 rounded-full  leading-none flex items-center",
                                      attrs: { type: "button" }
                                    },
                                    [_vm._v("Admin")]
                                  )
                                ...
                                ? _c(
                                    ...
                                    {
                                      staticClass:
                                        "px-4 ml-5 bg-yellow-400 text-white p-2 rounded-full  leading-none flex items-center",
                                      attrs: { type: "button" }
                                    },
                                    [_vm._v("Manager")]
                                  )
                                ...
                                ? _c(
                                    ...
                                    {
                                      staticClass:
                                        "px-4 ml-5 bg-blue-400 text-white p-2 rounded-full  leading-none flex items-center",
                                      attrs: { type: "button" }
                                    },
                                    [_vm._v("User")]
                                  )
